...
import { Navbar, Nav, Container, Form, FormControl, Button, NavDropdown, Image, Badge } from 'react-bootstrap';
            ...
            <Container fluid>
                ...
                <Navbar.Collapse id="navbar-content">
                    ...
                    <Nav className='me-auto'>
                        ...
                        >
                            <NavDropdown.Item as={Link} to={'/friends'}>All Friends</NavDropdown.Item>
                            <NavDropdown.Item as={Link} to={'/friend-requets'}>Friend requests</NavDropdown.Item>
                        </NavDropdown>
                    </Nav>
                    ...
                    <Nav className="ms-auto">
                        <NavDropdown
                            title={
                                <span>
                                    <Image
                                        src={user?.profileImage || constant.userIcon}
                                        roundedCircle
                                        height="30"
                                        className="me-2"
                                    />
