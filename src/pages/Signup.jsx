...
const Signup = () => {
  ...
  const { signupStatus, signupError, token } = useSelector(
    (state) => state.auth,
  ...
  useEffect(() => {
    if (signupStatus === "failed" && signupError) {
      dispatch(
        setShowAlert({ alert: true, message: signupError, variant: "danger" }),
      );
    }
      ...
      <div className="row">
        ...
        <div className="col mt-3">
          ...
          <form onSubmit={onSubmitHandler}>
            ...
            <div className="mb-3">
              <label for="formGroupExampleUsername" class="form-label">
                username
              </label>
              <input
                type="text"
